...
class SSD1306_Mini {
  ...
  public:
    ...
    // print a single character double size
    void printChar2( char ch, char row );
    
    // print a string to the screen double size
    void printString2( char col, char row, char * pText );
